...
public class OrderItems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_print=findViewById(R.id.btn_printfile);
        ...
        txv_orderStatus.setText("Your Order is "+orderStatus);
        txv_orderDate.setText("Order date "+orderDate);
        txv_orderCost.setText("SubTotal Kes "+orderCost);
        txv_orderID.setText("Order No "+orderID);
        txv_mapesaCose.setText("Reference Code "+mpesaCode);
