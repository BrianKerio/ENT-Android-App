...
<h3><span class="semi-bold">Invoiced Clients</span></h3>
</div>
<div class="row">
<div class="col-md-12">
...
<div class="grid-body no-border">
   ...
   RIGHT JOIN order_items p on o.order_id = p.order_id WHERE  o.order_status='4'";
        ...
        while($row=mysqli_fetch_array($query)){
            ...
            <tr class="odd gradeX">
                ...
                <td> Kes <?php echo $row['item_price']?> </td>
                <td><?php echo $row['order_date']?> </td>
                <td>Awaiting Customer Payment</td>
            </tr>
            <?php
