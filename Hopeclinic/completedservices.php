...
<h3><span class="semi-bold">Completed Service Provisions</span></h3>
</div>
<div class="row">
<div class="col-md-12">
...
<div class="grid-body no-border">
   ...
   RIGHT JOIN service_payment p on o.order_id = p.order_id WHERE  o.order_status='7'";
        ...
        while($row=mysqli_fetch_array($query)){
            ...
            <tr class="odd gradeX">
                ...
                <td>Aspirin,panadol</td>
                <td><?php echo $row['order_date']?> </td>
                <td>Service provision Complete</td>
            </tr>
            <?php
